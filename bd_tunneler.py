...
- __init__() attributes, and module functions, are ordered via above api flow.
...
- rich information about the search/request process can be gleaned by pprint( bd.__dict__ )
-------
